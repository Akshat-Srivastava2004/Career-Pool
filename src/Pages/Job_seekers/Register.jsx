...
const [jobPreference, setJobPreference] = useState("");
  const handleSubmit = async (e) => {
    e.preventDefault()
    register(firstName,lastName,email,password,phone,address,city,state,zipCode,education,experience,skills,resume,jobPreference)
  };
    ...
    <div className="container  mt-0">
      ...
      <div className="max-w-3xl mx-auto mt-10">
        <div className="mb-8 text-center">
          ...
          <p className="text-muted-foreground mt-2">Create your job seeker account and find your dream job</p>
        </div>
        ...
        <Tabs defaultValue="applicant" className="mb-6">
          <TabsList className="grid w-full grid-cols-2">
            ...
            <TabsTrigger value="employer" className="flex items-center gap-2" asChild>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Fill in your details to create your job seeker account</CardDescription>
          </CardHeader>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="phone" name="phone"   onChange={(e)=> setPhone(e.target.value) }  type="tel" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="zipCode" name="zipCode"  onChange={(e)=> setZipCode(e.target.value) }  />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select name="education" defaultValue="bachelors"  onChange={(e)=>setEducation(e.target.value)}>
                    <SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Select name="experience" defaultValue="1-3"  onChange={(e)=>setExperience(e.target.value)}>
                    <SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Select name="jobPreference" defaultValue="fulltime" onChange={(e)=>setJobPreference(e.target.value)}>
                    <SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Input id="resume" name="resume" type="file" onChange={(e)=>setResume(e.target.value)} />
